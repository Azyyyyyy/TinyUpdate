...
{
    public class MsDelta
    {
        public static bool CreateDelta(string oldFilePath, string newFilePath, string deltaFilePath)
        {
            return CreateDelta(FileTypeSet.ExecutablesLatest, GetCreateFlags(), CreateFlags.None, oldFilePath,
                newFilePath, null, null, new DeltaInput(), IntPtr.Zero, HashAlgId.Crc32, deltaFilePath);
        }

        public static bool ApplyDelta(string deltaFilePath, string oldFilePath, string newFilePath)
        {
            return ApplyDelta(ApplyFlags.None, oldFilePath, deltaFilePath, newFilePath);
        }
