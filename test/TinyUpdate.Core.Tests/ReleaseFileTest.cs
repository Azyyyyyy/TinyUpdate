...
namespace TinyUpdate.Core.Tests
{
    public class ReleaseFileTest
    {
        ...
        private static (string[] lines, ReleaseFile[] releaseFiles)[] testReadData =
        {
            ...
            new ReleaseFile[]
            {
                new("3AD4CBAB73D60FB3D7E6519E63129876C8F8600AE357B4E8D5624318DED0BDAB", "OvVc6XjutW7tgzyNKA_z6TD33", 1000),
                new("48266375EFC174F113D3901C974105E2820D7FF97D02CFE60618411B42DA78B2", "Vj9YyuXqq6OYtOG_ygfEdgQOg", 420),
                new("9CFAFA98346B577852F136BA8F2BE4913A3006F0FF780E9EB8DB90B16C5F0582", "QN7qPcqEXL_dFyKeMa95MDKuR", 1000, new Version(3, 8, 9)),
                new("64CA34314DE93365D718E81582A88940060087BEA3C2580F9136AED7FEE19F1D", "L95AMHJg84c5Krs8w80GebJBN", 691, new Version(3, 2, 4))
            })
        };
        ...
        private ReleaseFile[] CreateReleaseFiles()
        {
            ...
            for (int i = 0; i < releaseFiles.Length; i++)
            {
                ...
                releaseFiles[i] = new ReleaseFile(hash, Randomizer.GetString(), size, oldVersion);
            }
        ...
        private (string hash, long size, Version? oldVersion) CreateRandomFileData()
        {
            ...
            if (Randomizer.NextBool())
            {
                ...
                oldVersion = new Version(major, minor, build);
            }
